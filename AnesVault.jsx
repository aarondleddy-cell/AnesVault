          ...
          {loading ? (
            ...
            <div key={doc.id} className="doc-card" onClick={() => openPreview(doc)}>
              ...
              <div className="doc-footer">
                ...
                <button className="preview-btn" onClick={e => { e.stopPropagation(); openPreview(doc); }}>
                  <Icon name="eye" size={14} /> Preview & Download
                </button>
              </div>
            </div>
          ))}
          ...
          <div className="modal-box" style={{ position: "relative" }} onClick={e => e.stopPropagation()}>
            ...
            {previewDoc.file_url && (
              <div className="dl-options">
                <button className="dl-option-btn dl-option-pdf" onClick={handleDownloadPDF}>
