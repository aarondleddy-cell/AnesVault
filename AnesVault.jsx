...
const css = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .social-btn { display: flex; align-items: center; gap: 6px; padding: 8px 16px; border-radius: 100px; border: 1.5px solid rgba(255,255,255,0.25); background: rgba(255,255,255,0.08); color: ${S.white}; font-size: 13px; font-weight: 500; cursor: pointer; transition: all 0.2s; }
  ...
  .doc-card { background: ${S.white}; border: 1.5px solid ${S.border}; border-radius: 14px; padding: 16px; margin-bottom: 10px; transition: all 0.2s; }
  ...
  .dl-btn { display: flex; align-items: center; gap: 6px; padding: 8px 16px; background: ${S.teal}; color: white; border: none; border-radius: 8px; font-size: 13px; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Inter', sans-serif; text-decoration: none; }
  ...
  .modal-box { background: white; border-radius: 20px; padding: 32px 24px; max-width: 380px; width: 100%; box-shadow: 0 24px 80px rgba(0,0,0,0.3); }
          ...
          {loading ? (
            ...
            <div key={doc.id} className="doc-card">
              ...
              <div className="doc-footer">
                ...
                <button className="dl-btn" onClick={() => handleDownload(doc)}><Icon name="download" size={14} /> Download</button>
              </div>
            </div>
          ))}
        </div>
      ...
      {view === "guidelines" && (
        <div className="section-wrap">
          ...
          <div className="guidelines-card">
            ...
            <div className="moderation-note"><Icon name="shield" size={16} /> All uploads are reviewed by volunteer moderators from the community. Thank you for keeping AnesVault safe.</div>
          </div>
        </div>
      )}
      ...
      {view === "writeoffs" && (
        <div className="section-wrap">
          ...
          <div className="disclaimer-banner">
            ...
            <div><strong>Not tax advice.</strong> This is a general educational list for independent anesthesia providers. Always confirm deductions with a licensed CPA or tax professional before filing.</div>
          </div>
            ...
            <div key={group.group} className="writeoff-group">
              ...
              {group.items.map(item => (
                <div key={item.name} className="writeoff-item">
                  ...
                  <div><div className="writeoff-name">{item.name}</div><div className="writeoff-note">{item.note}</div></div>
                </div>
              ))}
            </div>
          ))}
