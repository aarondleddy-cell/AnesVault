        ...
        <div className="section-wrap">
          ...
          {!adminAuth ? (
            ...
            <>
              ...
              {/* APPROVED DOCS */}
              <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, fontWeight: 500, letterSpacing: "0.08em", textTransform: "uppercase", color: S.teal, marginBottom: 12, marginTop: 24 }}>
