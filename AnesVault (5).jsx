            ...
            <div className="preview-body">
              {previewDoc.fileData && previewDoc.fileType === "application/pdf" ? (
                <div style={{ marginBottom: 18 }}>
                  <iframe title="PDF preview" src={previewDoc.fileData} style={{ width: "100%", height: "50vh", border: `1px solid ${S.border}`, borderRadius: 12, background: "#fff" }}></iframe>
                </div>
              ) : previewDoc.fileData && previewDoc.fileType && previewDoc.fileType.startsWith("image/") ? (
                <div style={{ marginBottom: 18, textAlign: "center" }}>
                  <img alt="preview" src={previewDoc.fileData} style={{ maxWidth: "100%", maxHeight: "50vh", borderRadius: 12, border: `1px solid ${S.border}` }} />
                </div>
              ) : (
